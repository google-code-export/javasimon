...
/**
 * Interface for storing Simons' samples to relation database.
 *
...
public interface SqlStorage {
	 ...
	 */
	void storeStopwatch(long timestamp, List<StopwatchSample> stopwatchSamples);
	 ...
	 */
	void storeCounter(long timestamp, List<CounterSample> counterSamples);
