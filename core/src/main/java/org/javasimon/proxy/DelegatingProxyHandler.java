 ...
 * @author gerald
 */
public class DelegatingProxyHandler<T> implements InvocationHandler, Delegating<T> {
	/**
	 ...
	 */
	public DelegatingProxyHandler(T delegate) {
		super();
	...
	public interface InvocationFilter {
		/**
		 * Returns true if proxy is intecepting the method,
		 * or false is a direct call is done
		 * @param method Method
		 */
